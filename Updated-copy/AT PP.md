...
This Privacy Policy applies specifically to the FastTrackr Transition Platform. For our general website and other services, please refer to the applicable privacy policy at [fasttrackr.ai/privacy-policy](https://fasttrackr.ai/privacy-policy).
...
**“Advisor”** means any licensed or registered financial professional transitioning between financial services firms, or whose book of business is being acquired by, transferred to, or consolidated with another firm. This includes individuals affiliated with wirehouses, broker-dealers, RIAs, hybrid RIAs, bank trust departments, insurance-affiliated advisory platforms, and independent contractors.  
**“Client”** means any end-client or retail customer of an Advisor whose personal information is entered into or processed through the Platform by a User.  
**“Client Data”** means all data and personal information relating to Clients uploaded, entered, or otherwise provided through the Platform, including names, addresses, contact details, account information, financial information, and Sensitive Client Data.  
**“Sensitive Client Data”** means Client Data that is highly confidential or regulated, including Social Security Numbers (SSNs), government identification numbers, account numbers, financial account details, tax information, and nonpublic personal information (“NPI”).  
**“User Account Data”** means personal information of Users collected during registration and use of the Platform, such as name, email address, firm affiliation, and usage data.  
...
* Firm name, role, and business address  
* Registration credentials (managed through authentication systems)  
* Subscription and billing information (for paid accounts)  
...
* Household composition and member information  
* Account types and custodian details  
* Account numbers  
* Social Security Numbers (SSNs) and tax identification numbers  
* Financial holdings, balances, and account statements  
* Beneficiary and estate planning information  
* Identification documents  
* Any other personal or financial information included in documents, data uploads, or manual entry
...
* Create and manage User accounts and Projects  
* Authenticate User access to the Platform  
* Provide technical support and respond to inquiries  
* Send operational communications including onboarding, account updates, and security alerts  
...
* Provide the Platform services to the User, including storing, organizing, and structuring Household records for the transition Project;  
* Generate transition-related documents, forms, and outputs as directed by the User;  
* Enable enrichment workflows, including AI-assisted data extraction from documents and audio;  
...
* Under the Broker Protocol (where applicable), only limited Client information may be taken by a departing Advisor. Certain data is expressly prohibited;  
* For Non-Protocol Advisors, the permissibility of collecting or retaining any Client Data may be significantly more restricted;  
...
* Active Client Data is deleted from production systems within **30 days** of Project closure;  
* Backup copies are purged within **60 days** following deletion from active systems.

**7.2 Document Uploads** — Retained for the duration of the active Project and deleted within 30 days of Project closure or upon receipt of a deletion request.

**7.3 Audio Recordings and Transcripts** — Retained for the duration of the active Project and for up to **30 days** after project closure or upon receipt of a deletion request, after which they are permanently deleted.

**7.4 User Account Data** — Retained for the duration of the User's account and for up to 30 days following account termination, unless longer retention is required by law.

**7.5 Deletion Requests** — Users may request deletion of Client Data or their account by contacting contact@fasttrackr.ai. Requests will be processed within 30 days.
...
* Access controls and role-based permissions limiting who can access Client Data  
