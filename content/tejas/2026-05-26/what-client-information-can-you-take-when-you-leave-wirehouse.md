---
title: What Client Information Can You Take When You Leave a Wirehouse?
topic: "Advisor Transitions & Repapering"
categoryId: advisor-transitions-and-repapering
description: "A breakaway advisor's plain-English guide to what client information you can lawfully take when you leave a wirehouse — under the Broker Protocol and outside it."
image: what-client-information-can-you-take-when-you-leave-wirehouse.jpg
imageAlt: "Briefcase being packed at sunrise representing a breakaway advisor's transition from a wirehouse"
persona: Breakaway advisors leaving wirehouses for independence
...
The legal framework governing what client information you can take when you leave a wirehouse is controlled by two overlapping systems: the Broker Protocol (a voluntary agreement between member firms) and [FINRA Rule 4511](https://www.finra.org/rules-guidance/key-topics/books-records), which governs record retention and client data ownership more broadly. Getting these wrong isn't a compliance footnote — it's the difference between a smooth transition and a lawsuit that delays your launch by months.

According to a 2024 review of wirehouse-to-RIA transition disputes by [Investment News](https://www.investmentnews.com), the most common legal action against [breakaway advisors](/who-we-serve/breakaway-advisors) involves allegations of misappropriating client records — almost always because the advisor took more than the Broker Protocol permits.
...
To check current Protocol membership, consult [RIA in a Box](https://www.riainabox.com), which maintains an updated member list, or ask your compliance attorney.
...
5. Account title (e.g., "John Smith Revocable Trust")
...
According to [FINRA Rule 4511](https://www.finra.org/rules-guidance/rulebooks/finra-rules/4511), member firms must preserve all records relating to customer accounts for a minimum of six years. This obligation runs with the firm, not the advisor.
...
**Step 3: Repapering happens in parallel.** New account forms are generated for all accounts moving to the new custodian. For advisors moving $150M+ in client assets, this repapering volume is where transitions stall — often 300 to 1,000+ account forms across multiple [custodians](/who-we-serve/custodians), each with unique requirements.

[FastTrackr AI](/)'s [advisor transition platform](https://fasttrackr.ai) automates the repapering workflow — pulling authorized client data from custodians, pre-filling forms with validated data, and eliminating the NIGO rejections that typically delay completions by two to four weeks. Advisors who previously managed transitions manually in 90 days are completing them in 21 days with automated repapering.
...
Wirehouses use departure monitoring systems that flag unusual CRM queries, mass email downloads, and bulk data exports in the weeks before an advisor resigns. A 2025 report from [the Securities Litigation and Consulting Group](https://www.slcg.com) found that most firms conduct a forensic analysis of departing advisors' digital activity as standard practice.

If unauthorized data removal is found, the firm's legal department typically seeks:
1. A temporary restraining order preventing you from contacting the clients on the copied list
2. An injunction requiring you to return or destroy any copied records
3. Civil damages for any business lost as a result of your unauthorized solicitation
...
- [Investment News: Wirehouse Advisor Transition Disputes](https://www.investmentnews.com) — 2024
- [FINRA Rule 4511: Books and Records Requirements](https://www.finra.org/rules-guidance/rulebooks/finra-rules/4511)
- [RIA in a Box: Broker Protocol Member List](https://www.riainabox.com)
- [Securities Litigation and Consulting Group: Advisor Departure Monitoring](https://www.slcg.com) — 2025
- [Reddit r/CFP: Real advisor experiences with wirehouse breakaways](https://www.reddit.com/r/CFP/)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What client information can I legally take when leaving a wirehouse?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Under the Broker Protocol, advisors may take only five categories: client name, address, phone number, email address, and account title. Account numbers, holdings, statements, and any other records must remain with the firm. If your firm is not a Broker Protocol member, even those five fields may be restricted to publicly available information only."
      }
    },
    {
      "@type": "Question",
      "name": "Does the Broker Protocol still apply to Morgan Stanley advisors?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Morgan Stanley withdrew from the Broker Protocol in 2017. Advisors leaving Morgan Stanley face more restrictive rules and cannot take even the five standard Protocol data fields from firm records. They may only contact clients using publicly available information. Consult a transition attorney before resigning from any non-Protocol firm."
      }
    },
    {
      "@type": "Question",
      "name": "Can I take my book of business when I go independent?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can take your relationships but not the records. Clients are free to follow you, and once they authorize their accounts to transfer via ACATS, their complete account data moves with them legally. The distinction is between taking data before authorization (prohibited) and receiving it after client authorization (permitted)."
      }
    },
    {
      "@type": "Question",
      "name": "How long does the ACATS transfer process take?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Standard ACATS transfers complete in six business days. Non-ACATS transfers vary by asset type and custodian, commonly two to six weeks. Total transition timelines for advisors moving $100M+ in assets typically run 45 to 90 days when managed manually, and 21 to 35 days with automated repapering technology."
      }
    },
    {
      "@type": "Question",
      "name": "What should I do if my firm is not a Broker Protocol member?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Retain a securities attorney who specializes in advisor transitions before you resign. Non-Protocol transitions carry significantly higher legal risk, and the approach differs substantially from Protocol transitions — particularly around pre-resignation preparation, client communication timing, and what you can say to clients in the first 24 hours after you resign."
      }
    },
    {
      "@type": "Question",
      "name": "Can I take notes I wrote myself about clients?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Notes created in the firm's CRM system, even if you wrote them yourself, belong to the firm. Personal notes written in personal notebooks or personal apps not on the firm's systems exist in a legal gray area. Consult your attorney. The safest approach is to assume all records touching the firm's infrastructure belong to the firm."
      }
    },
    {
      "@type": "Question",
      "name": "How do I rebuild client relationship context after a Protocol transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Client consent forms and ACATS transfers bring the account data legally. For the relationship context — investment preferences, risk tolerance, family details — the answer is the first client conversation after the transition. Most advisors find that a 20-minute onboarding call with each client restores working relationship context faster than expected."
      }
    }
  ]
}
