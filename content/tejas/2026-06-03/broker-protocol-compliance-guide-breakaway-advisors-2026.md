---
title: Broker Protocol Compliance Guide for Breakaway Advisors (2026 Edition)
...
Two adjacent items often missed: the advisor cannot take a copy of their book of business analytics or any production reports, even though those reports are about the advisor's own production. Those are firm records under [FINRA Rule 4511](https://www.finra.org/rules-guidance/key-topics/books-records). And the advisor cannot use the firm's email or messaging systems to begin coordinating the move with the new firm. Every recruitment communication should be conducted on personal email and personal devices, ideally through transition counsel as the intermediary.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is Morgan Stanley still in the Broker Protocol in 2026?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Morgan Stanley withdrew from the Broker Protocol on October 30, 2017, and remains out as of 2026. An advisor leaving Morgan Stanley today has no Protocol protection and cannot legally take any client contact information out of the firm. The exit must be planned as a litigation-defense workflow led by experienced transition counsel."
      }
    },
    {
      "@type": "Question",
      "name": "Is UBS still in the Broker Protocol in 2026?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. UBS withdrew from the Broker Protocol on November 27, 2017, twenty-eight days after Morgan Stanley. UBS advisors face the same constraints as Morgan Stanley advisors and should plan a non-Protocol exit with transition counsel, no client list at the door, and a client-initiated outreach model post-resignation."
      }
    },
    {
      "@type": "Question",
      "name": "Which major wirehouses are still in the Broker Protocol?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "As of 2026, Wells Fargo Advisors and Merrill Lynch remain Broker Protocol members. Both have been members since the early years of the agreement. An advisor leaving either firm operates under standard Protocol mechanics: five fields on one list, handed over at resignation, with immediate ability to contact clients at the new firm."
      }
    },
    {
      "@type": "Question",
      "name": "What information can an advisor legally take under the Broker Protocol?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Five fields, on one document, for each client the advisor served: client name, address, phone number, email address, and account title. Nothing else. Account numbers, balances, statements, social security numbers, and any CRM data beyond those five fields cannot be taken. The list must be handed to the firm being left at the moment of resignation."
      }
    },
    {
      "@type": "Question",
      "name": "What is the dark period in a non-Protocol advisor transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The dark period is the window between resignation and the point at which the advisor can lawfully contact prior clients. In a Protocol move, it is essentially zero. In a non-Protocol exit from Morgan Stanley or UBS, the dark period typically lasts seven to twenty-one days while the TRO motion is litigated."
      }
    },
    {
      "@type": "Question",
      "name": "How long does a Broker Protocol transition take versus a non-Protocol exit?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A well-executed Protocol transition from a wirehouse like Wells Fargo or Merrill to an RIA typically takes twenty-one to thirty-five days end to end. A non-Protocol exit from Morgan Stanley or UBS typically takes thirty-five to sixty days, with the additional time consumed by TRO litigation and the client-initiated outreach model."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if an advisor takes information beyond the five Protocol fields?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Taking anything beyond the five Protocol fields, even a single screenshot of an account balance, defeats Protocol protection and creates a trade-secret claim that the old firm will pursue. It is also typically a Regulation S-P violation. The advisor and the new firm both face exposure. Counsel will require deletion affidavits and forensic device review."
      }
    },
    {
      "@type": "Question",
      "name": "How does [repapering automation](/solutions/advisor-transitions) affect AUM retention in a wirehouse transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AUM retention is largely a function of how fast the new firm can convert each client conversation into a signed, opened, funded account. Automated repapering reduces NIGO rates by approximately 95% and compresses end-to-end transition time by roughly 75% compared to manual workflows. The compression matters most in non-Protocol exits."
      }
    }
  ]
}
...
**Related:** [Meeting Assistant](/solutions/meeting-assistant) · [For Transition Consultants](/who-we-serve/transition-consultants) · [For Breakaway Advisors](/who-we-serve/breakaway-advisors)
