---
title: "18,000 Advisors Move Firms Every Year. Here's Where the $19 Billion in Lost Assets Goes"
topic: "Advisor Trends & Industry"
categoryId: advisor-trends-behavior-and-industry-commentary
description: "Roughly 18,000 advisors change firms every year and an estimated $19 billion in client assets fail to follow them. Here is where that leakage occurs — and which transition technology choices recover the most."
image: 18000-advisors-19-billion-lost-assets.jpg
imageAlt: Industry chart of annual advisor moves and assets that fail to transfer
persona: Growth-focused RIA owner tracking industry movement
...
Where'd they go? RIAs captured 17,000+. Wirehouses lost 1,864 net. [Independent broker-dealers](/who-we-serve/independent-broker-dealers) lost 480 net. The channel shift is real. Smaller, more nimble platforms are winning.
...
The math shifts when execution is tight. Well-executed transitions retain 86-90%+ of assets. [Breakaway advisors](/who-we-serve/breakaway-advisors) starting their own firms retain about 62%. The gap isn't random—it's operational.
...
1. **Diamond Consultants advisor movement data** — 11,172 experienced advisors switched firms in 2025, 16.2% increase YoY. Source: [Wealthmanagement.com](https://www.wealthmanagement.com) article on 2025 advisor movement.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How many advisors actually switched firms in 2025?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Diamond Consultants tracked 11,172 experienced advisors moving between firms in 2025. Industry-wide, the total is closer to 18,000. That's a 16.2% increase from 2024, the largest year-on-year jump on record."
      }
    },
    {
      "@type": "Question",
      "name": "Where do most advisors go when they leave?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "RIAs captured 17,000+ advisors in 2025. Wirehouses lost 1,864 net. Independent broker-dealers lost 480 net. The trend shows advisors moving toward independent RIA platforms, away from employee models."
      }
    },
    {
      "@type": "Question",
      "name": "How much client assets are lost when advisors move?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Asset loss depends on transition type. B/D-to-B/D loses ~22%. B/D-to-independent loses ~18%. Independent-to-independent retains ~89%. Industry-wide, $19 billion moves annually with varying loss rates."
      }
    },
    {
      "@type": "Question",
      "name": "Why do some transitions retain 90% of assets while others lose 62%?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Execution quality drives the gap. Operationally tight transitions with ACATS automation retain 86-90%+. Ad-hoc breakaway moves with manual processes retain ~62%. Automated systems achieve 12% NIGO vs. 60-87% for paper-based transfers."
      }
    },
    {
      "@type": "Question",
      "name": "What percentage of transfers go wrong (NIGO)?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Paper-based ACATS transfers encounter issues 60-87% of the time. Automated transfer management systems reduce this to 12%. Each problematic transfer extends timeline weeks or months, increasing client abandonment risk."
      }
    },
    {
      "@type": "Question",
      "name": "Why are advisors leaving wirehouses specifically?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Compensation is the top reason (78%). But 38% of advisors retiring by 2034 creates urgency. Advisors seek platforms with modern tech and succession support. Wirehouses are consolidating, forcing exits."
      }
    },
    {
      "@type": "Question",
      "name": "What should RIA owners do to retain assets during transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Automate ACATS workflows (cuts NIGO 60%+ to 12%). Build CRM hygiene protocols. Create transition playbooks with client comms. The difference between 78% and 90% retention on a $100M book is $120,000+ annually."
      }
    }
  ]
}
