---
title: 4 Questions Every Client Asks During an Advisor Transition (And How to Answer Them Fast)
topic: "Client Communication & Notetaking"
categoryId: ai-in-client-communication-and-notetaking
description: Four specific client questions dominate every advisor transition — and the quality of your answers determines how much of your book actually follows you to the new firm.
image: client-questions-advisor-transition-answers.jpg
imageAlt: Financial advisor on a video call walking a client through transition paperwork
persona: Established Advisor Considering Independence
...
> **Key Takeaway:** Client communication during an advisor transition isn't a courtesy — it's retention strategy. [Cerulli Associates](https://www.cerulli.com/resource/white-paper-advisors-in-transition-challenges-and-best-practices) research shows advisors switching firms lose approximately 18-22% of AUM. The advisors who retain the most are the ones who communicate fastest and most specifically.
...
[FINRA Rule 11870](https://www.finra.org/rules-guidance/key-topics/customer-account-transfers) requires [custodians](/who-we-serve/custodians) to complete validated account transfers within three business days. Most advisors don't know this — and most clients certainly don't. Explaining that the regulatory framework moves accounts quickly, and that the paperwork phase is the variable, gives clients a timeline they can reason about.
...
According to [AdvisorFinder's ACATS transfer guide](https://advisorfinder.com/blog-posts/acat-transfer-guide-switch-brokers-without-selling), most ACATS transfers move individual stocks, bonds, mutual funds, ETFs, and options positions seamlessly. This is the right message because it answers the client's real concern: "Are you going to sell my investments and trigger taxes?"
...
- [Cerulli Associates — Advisors in Transition: Challenges and Best Practices](https://www.cerulli.com/resource/white-paper-advisors-in-transition-challenges-and-best-practices)
- [SavvyWealth — 5 Steps to Transitioning Financial Advisor Clients](https://www.savvywealth.com/blog-posts/transitioning-fa-clients)
- [FINRA — Customer Account Transfers (Rule 11870)](https://www.finra.org/rules-guidance/key-topics/customer-account-transfers)
- [RFG Advisory — The Financial Advisor Transition: How to Tell Your Clients](https://rfgadvisory.com/blog/financial-advisor-transition/)
- [AdvisorFinder — ACAT Transfer: Complete Guide to Switching Brokers](https://advisorfinder.com/blog-posts/acat-transfer-guide-switch-brokers-without-selling)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What questions do clients most commonly ask during an advisor transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The four most common client questions are: why they need to sign new paperwork, how long the process will take, whether their investments will change, and what happens if something goes wrong. Advisors who answer all four proactively — before clients ask — report significantly higher client retention during firm moves."
      }
    },
    {
      "@type": "Question",
      "name": "How do you explain to a client why they have to sign new paperwork?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Explain that regulatory rules require new authorization documentation when accounts move between custodians — this is a protective mechanism, not an administrative burden. Frame it around protection: this is how we verify you're authorizing the transfer and how we protect your assets. Be specific about what they're signing and how long it takes."
      }
    },
    {
      "@type": "Question",
      "name": "How long does an advisor transition typically take for clients?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A transition using automated platforms takes 10-21 days end-to-end, including paperwork, submission, ACATS transfer (3 business days per FINRA Rule 11870), and account activation. Manual workflows average 60-90 days. Advisors using FastTrackr can give clients a specific 21-day-or-less timeline rather than the vague 'a few months' that erodes trust."
      }
    },
    {
      "@type": "Question",
      "name": "Will client investments change during an advisor transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In most cases, investment positions transfer in-kind through the ACATS system without being sold or liquidated. Stocks, bonds, ETFs, and most mutual funds move as-is. Some proprietary products held at the current custodian may not transfer and may need to be liquidated — advisors should identify and communicate these situations proactively."
      }
    },
    {
      "@type": "Question",
      "name": "How do you retain client trust when switching firms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Client retention during advisor transitions depends on proactive communication, specific answers about timeline and investments, and demonstrated control over the process. According to Cerulli Associates, transition support quality is directly correlated with asset retention — advisors who manage the process visibly retain significantly more AUM."
      }
    },
    {
      "@type": "Question",
      "name": "What's the best way to communicate a firm change to long-standing clients?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Contact long-standing clients individually before the transition officially begins. The call or message should cover: what's changing, what's not changing, exactly what the client needs to do, and a direct line for questions. Follow up within 48 hours of the initial paperwork request to confirm receipt and answer questions before concern escalates."
      }
    },
    {
      "@type": "Question",
      "name": "How do you answer 'will my investments change' during an advisor transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tell clients directly: your portfolio positions transfer as-is through the ACATS system. Nothing about your investment strategy changes unless we decide together to change it. The only thing that changes is where your accounts are held. If any positions won't transfer in-kind, address that specifically and in advance — surprises damage trust more than honest communication."
      }
    }
  ]
}
