---
title: "The 'Dark Period' After Wirehouse Resignation: Tools to Compress It"
topic: "Advisor Transitions & Repapering"
categoryId: advisor-transitions-and-repapering
description: The dark period between wirehouse resignation and full activation at a new RIA is when advisors lose clients and revenue. Here are the tools and workflow tactics that compress it from 90 days to 21.
image: dark-period-wirehouse-resignation-tools-to-compress.jpg
imageAlt: Timeline illustration of the wirehouse-to-RIA dark period showing tools that compress activation
persona: Breakaway wirehouse advisors planning a move and the firms recruiting them
author: FastTrackr AI Team
---
# The 'Dark Period' After Wirehouse Resignation: Tools to Compress It

The dark period is the window between resigning from a wirehouse and activating accounts at the new firm—typically 30 to 90 days. During the dark period, the advisor cannot bill fees on prior clients (the wirehouse still owns them) and cannot yet bill new accounts (assets have not transferred). Tools that compress this window—[document automation](/solutions/document-intelligence), custodian-native ACATS, AI-driven NIGO triage, pre-resignation prep, and a single workflow dashboard—are the difference between a manageable transition and a financial crisis.
...
Pre-built templates for [Schwab Advisor Services](https://www.schwab.com/advisor-services), [Fidelity](https://www.fidelity.com/wealth-services/working-with-fidelity) Wealthscape, and [Pershing](https://www.pershing.com) NetX360+ that the platform fills automatically from the client master record. One advisor click generates a 60-document repapering bundle ready for client signature.
...
Before signing a term sheet, [breakaway advisors](/who-we-serve/breakaway-advisors) should ask the new firm:

1. Show me your pre-resignation workspace.
2. Demonstrate the document template for one of my [custodians](/who-we-serve/custodians).
3. Walk me through a recent NIGO remediation case (anonymized).
4. Show me your ACATS exception dashboard.
5. What is your average time-to-activation for the last 10 transitions?
6. Will I have an advisor-facing dashboard during my transition?
...
**How long is the typical dark period for a wirehouse-to-RIA breakaway?**
30 to 90 days. Manual processes average 60–90 days. Mature tooling brings it to 21–35 days.

**Can pre-resignation work legally be done before resignation?**
Most of it can. State licensing checks, Form ADV draft, custodian onboarding registration, and employment counsel briefings are all legal pre-resignation. Soliciting clients is not. Work with counsel to draw the line.

**What is a transition bridge payment, and should I expect one?**
A bridge payment is upfront capital from the new firm to cover the dark period's cash flow gap. Common for advisors with $100M+ AUM. Typical bridges are 6–12 months of expected fees, amortized through forgivable notes tied to AUM retention.

**Why do NIGOs cause so much delay?**
A NIGO restarts the custodian's clock. A 5-day submission cycle plus a 5-day NIGO cycle plus a 5-day resubmission cycle is 15 days for one document. AI triage cuts the middle 5 days to 1 day.

**How do I track U5 filing status?**
Through FINRA's BrokerCheck and via the new firm's compliance team contacting the prior firm. A good transition platform proactively tracks U5 status against the 30-day window.

**What happens if my prior firm files U5 late?**
Your new firm's ACATS submissions are blocked. Your CCO at the new firm should escalate to the prior firm's CCO at Day 21 and file a complaint with FINRA if Day 30 passes without filing. See [FINRA Rule 4511](https://www.finra.org/rules-guidance/key-topics/books-records) for books-and-records context.

**Can I work with clients during the dark period?**
You can respond to clients who initiate contact (subject to non-solicitation enforceability in your state) and answer questions about the new firm. Specific solicitation rules vary by state; check with counsel.

**What is the single most valuable tool to compress the dark period?**
Pre-resignation prep platform. Doing 30–60 days of work *before* resignation eliminates 25 days of delay that would otherwise happen post-resignation. The other five tools compress what remains.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long is the typical dark period for a wirehouse-to-RIA breakaway?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "30 to 90 days. Manual processes average 60–90 days. Mature tooling brings it to 21–35 days."
      }
    },
    {
      "@type": "Question",
      "name": "Can pre-resignation work legally be done before resignation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most of it can. State licensing checks, Form ADV draft, custodian onboarding registration, and employment counsel briefings are all legal pre-resignation."
      }
    },
    {
      "@type": "Question",
      "name": "What is a transition bridge payment, and should I expect one?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A bridge payment is upfront capital from the new firm to cover the dark period's cash flow gap. Common for advisors with $100M+ AUM."
      }
    },
    {
      "@type": "Question",
      "name": "Why do NIGOs cause so much delay?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A NIGO restarts the custodian's clock. AI triage cuts the manual NIGO remediation cycle from roughly 6 business days to 1.5."
      }
    },
    {
      "@type": "Question",
      "name": "How do I track U5 filing status?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Through FINRA's BrokerCheck and via the new firm's compliance team contacting the prior firm. A good transition platform proactively tracks U5 status."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if my prior firm files U5 late?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Your new firm's ACATS submissions are blocked. Escalate to the prior firm's CCO at Day 21 and file a complaint with FINRA if Day 30 passes without filing."
      }
    },
    {
      "@type": "Question",
      "name": "Can I work with clients during the dark period?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can respond to clients who initiate contact (subject to non-solicitation enforceability in your state). Specific solicitation rules vary by state; check with counsel."
      }
    },
    {
      "@type": "Question",
      "name": "What is the single most valuable tool to compress the dark period?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pre-resignation prep platform. Doing 30–60 days of work before resignation eliminates 25 days of delay post-resignation."
      }
    }
  ]
}
