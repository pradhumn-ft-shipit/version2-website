---
title: "Broker-Dealer to RIA: Going Fee-Only Without Losing Half Your Practice's Revenue"
date: 2026-09-06
author: FastTrackr AI Team
topic: "Advisor Transitions & Repapering"
description: "Converting a commission book to fee-only: which revenue survives, what it recaptures, the hybrid trade-offs, and how deep the trough gets before advisory compounds."
persona: A broker-dealer advisor with meaningful commission revenue weighing a fee-only move
image: /blog-images/2026-05-14-ria-growth-playbook-technology-stack-2026.jpg
imageAlt: "An advisor mapping a commission book onto an RIA technology stack"
slug: bd-to-ria
---
...
1. **Convert to fee-based versions.** A growing marketplace of advisory (fee-based) variable annuities lets you move a VA position into a wrapper your RIA can bill as advisory assets. This is the cleanest long-term answer where the product and the client both support it, but it's a client-by-client conversion, not a switch you flip.
2. **Keep a limited broker-dealer affiliation (go hybrid).** Retain your registration with a broker-dealer so the trails keep flowing while your RIA runs the advisory side. Convenient — and, as the trade-offs below show, not free.
3. **Retain insurance and annuity business through an outside arrangement.** Hold the insurance and annuity commissions through an outside insurance license or an independent marketing organization, or a retained relationship, rather than routing them through the RIA at all.
...
1. **Size the commission book** by type — advisory, trails, C-shares, insurance/annuity, non-traded — so you know what's at stake in each bucket.
2. **Decide the structure**: pure fee-only, hybrid as a bridge, or hybrid indefinitely, based on how much of the book is convertible versus stuck.
3. **Move the advisory assets first.** They repaper cleanly and start the new revenue line, even though quarterly-in-arrears billing delays the first fee.
4. **Convert what's convertible** — fee-based VA wrappers and share-class changes — client by client, where the product and suitability support it.
5. **Retain the rest** through a limited BD affiliation or an outside insurance arrangement, and mark the non-portable products as revenue you may not recover.
6. **Collapse to pure fee-only** when the retained commission revenue has thinned enough that keeping the registration costs more than it earns.
...
If you're weighing this against building your own firm from scratch, [the full RIA build](/blog/bd-to-own-ria) lays out the sequence; to pressure-test the economics against staying put, run your numbers through [the real breakeven](/blog/the-real-breakeven); and to see this route beside every other, start with [the full map of your options](/blog/every-path-out-pillar). The revenue you're afraid of losing is mostly recoverable — but only if you plan the conversion instead of discovering it.
