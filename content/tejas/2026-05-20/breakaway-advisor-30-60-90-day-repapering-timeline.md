---
title: "The Breakaway Advisor's 30-60-90 Day Repapering Timeline: What to Expect"
topic: "Advisor Transitions & Repapering"
categoryId: advisor-transitions-and-repapering
description: "A breakaway advisor with $150M in assets can expect repapering to take 60 to 90 days manually, or 21 to 35 days with automation. Here is the 30-60-90 day framework for each phase."
image: breakaway-advisor-30-60-90-day-repapering-timeline.jpg
imageAlt: Breakaway advisor reviewing a 30-60-90 day repapering timeline on a tablet with milestones marked
persona: Established advisors considering or preparing for independence
...
**Which custodian you're moving to.** Custodian choice affects timeline because [custodians](/who-we-serve/custodians) differ in processing speed and form complexity. [Fidelity](https://www.fidelity.com/wealth-services/working-with-fidelity) and Schwab process standard ACATS transfers in 5 to 7 business days. [Pershing](https://www.pershing.com)'s institutional processing runs 7 to 12 days. If you're aggregating accounts from multiple custodians, the slowest custodian determines your completion date.
...
[FastTrackr AI](/)'s [advisor transition platform](https://fasttrackr.ai) generates all forms automatically from validated account data, pre-fills every field, and routes the signature package to each client digitally — compressing the form generation and signature collection phase from two weeks to three to four days.
...
[According to Investment News research from 2025](https://www.investmentnews.com), advisors who provided account-specific completion confirmations retained 96% of their book within 12 months post-transition, compared to 87% for advisors who provided only a final "all accounts transferred" communication.
...
- [J.D. Power: Wealth Management Client Satisfaction During Transitions](https://www.jdpower.com) — 2025
- [Investment News: Breakaway Advisor AUM Retention Study](https://www.investmentnews.com) — 2025
- [FINRA: Broker Protocol and Advisor Transition Compliance](https://www.finra.org)
- [Broadridge Financial Solutions: NIGO Rate Analysis for Advisor Transitions](https://www.broadridge.com) — 2024
- [Reddit r/CFP: Breakaway advisor transition experiences](https://www.reddit.com/r/CFP/)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long does repapering take for a breakaway advisor with $150M in client assets?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A $150M book with 300 accounts takes 60 to 90 days using manual processes and 21 to 35 days with automated repapering technology. The primary variables are NIGO rate (determined by data validation quality in phase one) and custodian processing speed. Fidelity and Schwab process standard ACATS transfers in 5 to 7 business days; Pershing runs 7 to 12 days."
      }
    },
    {
      "@type": "Question",
      "name": "What is the 30-60-90 day breakaway timeline?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Days 1 to 30 cover data intake, validation, and form generation. Days 31 to 60 cover custodian submission and active tracking. Days 61 to 90 cover NIGO remediation and account confirmation. Advisors who front-load data validation in phase one consistently complete in 60 to 75 days. Advisors who skip validation frequently extend past 90 days due to high NIGO rates in phase three."
      }
    },
    {
      "@type": "Question",
      "name": "What is a NIGO and how common are they in advisor transitions?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NIGO stands for Not in Good Order — a custodian's rejection of a submitted transfer form because of missing or incorrect information. Industry-average NIGO rates for manual repapering run 18% to 22% on first submission. With pre-submission data validation, rates of 3% to 5% are achievable. Every NIGO adds 10 to 14 business days to that account's timeline."
      }
    },
    {
      "@type": "Question",
      "name": "What data validation should a breakaway advisor run before generating forms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Validate: mailing address (current and correctly formatted), beneficiary designation (present on all applicable accounts), account title (matching the receiving custodian's records), account type (correct form type available), and Tax ID or SSN for all corporate accounts. Running these checks before form generation prevents the majority of NIGO rejections that extend transition timelines."
      }
    },
    {
      "@type": "Question",
      "name": "How should a breakaway advisor communicate with clients during the repapering process?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Three communications matter most: an initial confirmation when the transfer authorization is signed, a submission confirmation when forms reach the custodian with expected completion timeline, and an account-specific completion notice when each account confirms transfer. Account-specific completion communications retain 9% more AUM over 12 months than blanket completion messages."
      }
    },
    {
      "@type": "Question",
      "name": "Can a $150M advisor transition be completed in less than 30 days?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "With automated repapering technology, a $150M book with 300 accounts can complete in 21 to 28 days when: all clients return signed authorizations within the first week, data validation surfaces no major gaps, and the receiving custodian is a faster processor like Fidelity or Schwab. Most automated transitions settle in the 21 to 35 day range."
      }
    }
  ]
}
